...
FG_eval_old::FG_eval_old(){};

FG_eval_old::FG_eval_old(double _xp, double _yp, double _ap, double _dist, double _ang, double _yaw, double _K1, double _K2, double _K3, double _K4, double _K5, double _preV, double _preW){
  xp = _xp;
  yp = _yp;
  ap = _ap;
  dist = _dist;
...
void FG_eval_old::operator()(ADvector& fg, const ADvector& x)
{
...
myNLP_old::myNLP_old(double _vmax, double _wmax){
  vmax = _vmax;
  wmax = _wmax;
}  

void myNLP_old::my_solve(double xp, double yp, double ap, double dist, double ang, double yaw, double K1, double K2, double K3, double K4, double K5){
    ...
    FG_eval_old fg_eval(xp,yp,ap, dist, ang, yaw, K1, K2, K3, K4, K5, preV, preW);
    ...
    // solve the problem
    CppAD::ipopt::solve<Dvector, FG_eval_old>(
...
void myNLP_old::save_solution(CppAD::ipopt::solve_result<Dvector> solution){
