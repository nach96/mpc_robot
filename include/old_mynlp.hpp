...
#ifndef FG_EVAL_OLD_H
#define FG_EVAL_OLD_H
...
public:
    ...
    FG_eval_old();
    FG_eval_old(double _xp,  double _yp, double _ap, double _dist, double _ang, double _yaw, double _K1, double _K2, double _K3, double _K4, double _K5, double _preV, double _preW);
...
{
public:
    myNLP_old(double _vmax, double _wmax);
